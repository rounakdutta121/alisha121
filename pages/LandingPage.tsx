...
const LandingPage: React.FC<LandingPageProps> = ({ onNavigate }) => {
  return (
    <div className="relative z-10">
      ...
      <section className="min-h-screen relative flex items-center pt-32 pb-12 md:pt-24 md:pb-12 px-6 overflow-hidden">
      ...
      <section className="py-16 md:py-24 px-6 bg-black/10">
